...
IShader::~IShader(){}
Vec4f IShader::vertex(int iface, int nthvert){return Vec4f();}
bool IShader::fragment(Vec3f bar, TGAColor &color){return false;}
//视角矩阵
...
void lookat(Vec3f eye, Vec3f center, Vec3f up) {
    Vec3f z = (eye-center).normalize();     //Camera Direction
    Vec3f x = cross(up,z).normalize();      //Right Vector
    Vec3f y = cross(z,x).normalize();       //Up Vector
